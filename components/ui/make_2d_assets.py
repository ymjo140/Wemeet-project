...
try:
    ...
    print("pip install Pillow 명령어로 라이브러리를 설치해주세요.")
    sys.exit(1)
...
def create_assets():
    ...
    # 노란 티셔츠
    img = new_img(); d = ImageDraw.Draw(img)
    draw_rect(d, 43, 100, 64, 85, "#FCD34D") 
    ...
    draw_rect(d, 20, 100, 25, 80, "#4ADE80") 
    ...
    draw_rect(d, 73, 200, 4, 90, "#1E40AF") # 가랑이
